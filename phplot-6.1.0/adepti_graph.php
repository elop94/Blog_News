...
$graph_height=300; //Height of entire graph
$graph_padding=20; //Padding for edges of graph
$graph_title="Daily Summary"; //Graph title
$left_title="Transactions"; //Y-axis title
...
$use_logo=1; //Add logo to the bottom of your graph? 1-Yes 0-No
